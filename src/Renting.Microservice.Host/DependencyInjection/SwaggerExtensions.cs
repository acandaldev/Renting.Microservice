...
using Renting.Microservice.Host.Configuration;
using Renting.Microservice.Host.Infrastructure.Swagger;

namespace Renting.Microservice.Host.DependencyInjection
{
            ...
            IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.OAuthClientId("client-renting-swagger");
                    options.OAuthClientSecret("renting-secret");
